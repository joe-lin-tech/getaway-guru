...
const Navigation = () => {
  ...
  return (
    <header className="sticky absolute inset-x-0 top-0 z-50 w-full">
      <nav className="flex items-center justify-between p-6 lg:px-8 backdrop-blur-lg" aria-label="Global">
