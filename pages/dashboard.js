  ...
  return (
    <div className="bg-white w-full">
      <div
        ...
        aria-hidden="true"
      >
        <div className="bg-gray-300 flex-1 flex flex-col space-y-5 lg:space-y-0 lg:flex-row lg:space-x-10 sm:p-6 sm:rounded-2xl opacity-90">
          <div className="bg-gray-700 px-2 lg:px-4 py-2 lg:py-10 sm:rounded-xl flex lg:flex-col justify-between">
          ...
          <div className="flex-1 px-2 sm:px-0">
            <div className="flex justify-between items-center">
              <div className="flex-col justify-start">
                <h3 className="text-4xl font-light text-black">Welcome back, Joe Lin!</h3>
                <h4 className="text-3xl font-extralight text-black">Liked Trips</h4>
              </div>
            ...
            <div className="mb-10 sm:mb-0 mt-4 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              <div className="relative group bg-gray-900 py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/80 hover:smooth-hover">
                ...
                <h4 className="text-white text-2xl font-bold capitalize text-center">Trips</h4>
                <p className="text-white/50">07 members</p>
